        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              placeholder="250000"
              className="w-full p-4 border border-gray-200 rounded-xl text-lg font-medium focus:ring-2 focus:ring-green-500 focus:border-transparent"
              required
              min="0"
              step="1000"
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-4 border border-gray-200 rounded-xl text-base focus:ring-2 focus:ring-green-500 focus:border-transparent"
              required
            />
          </div>
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              disabled={loading}
              className="
                flex-1 bg-green-500 text-white p-4 rounded-xl 
              ...
              "
            >
              {loading ? '⏳ Обработка...' : '✅ Добавить приход'}
            </button>
            <button
              type="button"
              onClick={handleBackdrop}
